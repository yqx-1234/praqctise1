...
#define  PRODUCTKEY           "a1QFeJHSoAp"                                        //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                                   //产品ID长度
#define  DEVICENAME           "Y002"                                               //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                                   //设备名长度
#define  DEVICESECRE          "7fb2f18c4f95944018d8127f463835d7"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  S_TOPIC_NAME         "/sys/a1QFeJHSoAp/Y002/thing/service/property/set"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/sys/a1QFeJHSoAp/Y002/thing/event/property/post"    //需要发布的主题     
