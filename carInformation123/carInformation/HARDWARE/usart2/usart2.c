...
{  	 	
	...
	USART_DeInit(USART2);                                               //串口2寄存器重新设置为默认值
	 ...
	 GPIO_PinAFConfig(GPIOA,GPIO_PinSource3,GPIO_AF_USART2);//设置PA2与PA3复用功能串口1
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2|GPIO_Pin_3;              //准备设置PA2、PA3
	  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;      //IO速率50M
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;	          //复用功能，用于串口2
