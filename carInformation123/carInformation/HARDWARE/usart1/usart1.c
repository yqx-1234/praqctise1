...
{  	 	
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_9|GPIO_Pin_10;              //准备设置PA9
	  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;      //IO速率100M
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;	       //复用推挽输出，用于串口1的发送
	  GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;      //推挽输出
		GPIO_InitStructure.GPIO_PuPd=GPIO_PuPd_UP;        //上拉电阻模式
    GPIO_Init(GPIOA, &GPIO_InitStructure);                 //设置PA9,PA10
